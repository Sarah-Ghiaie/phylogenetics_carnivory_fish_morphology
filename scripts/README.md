...
| step_04_cichlid_mapping_traits.R | Performs an ancestral state reconstruction of feeding strategies on the rooted tree. Performs additional analyses to summarize phylogeny diversity. |
