...
Files contained in the **scripts/** directory can be run in order. R and RStudio are required to run these scripts. <br>
Alignments are performed using MAFFT online version. <br>
